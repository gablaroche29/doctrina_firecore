...
public class Toggle {
    ...
    public void draw(Canvas canvas) {
        if (active) {
            ...
            canvas.drawRectangle(bounds.getX() + 4, bounds.getY() + 4, bounds.getWidth() - 8, bounds.getHeight() - 8, activeColor);
            ...
            canvas.drawRectangle(bounds.getX() + 7 + (bounds.getWidth() - 35), bounds.getY() + 7, 21, 21, activeColor);
